const hotelData = {
    "Uluwatu Ocean View Resort": {
        ...
        image: "assets/prop_resort_1777425922004.png",
        ratingScore: 4.8,
        ratingCount: 154,
        facilities: [
    ...
    "Seminyak Private Villa": {
        ...
        image: "assets/prop_villa_1777425939174.png",
        ratingScore: 4.6,
        ratingCount: 128,
        facilities: [
        ...
        rooms: [
            ...
            { name: "3 Bedroom Family Villa", description: "Spacious villa accommodating up to 6 guests with full amenities.", price: 380, type: "room" }
        ],
        reviews: [
    ...
    "Grand Indonesia Luxury Hotel": {
        ...
        image: "assets/prop_hotel_1777425881911.png",
        ratingScore: 4.7,
        ratingCount: 189,
        facilities: [
            { icon: "fa-wifi", name: "Free WiFi" },
        ...
        rooms: [
            { name: "Deluxe City Room", description: "Modern room with stunning views of the Jakarta skyline.", price: 150, type: "room" },
            { name: "Executive Suite", description: "Includes access to the Executive Lounge with complimentary breakfast and evening cocktails.", price: 250, type: "room" },
            { name: "Grand Penthouse Suite", description: "Spacious living area, marble bathroom, and panoramic city views.", price: 500, type: "room" }
        ],
        reviews: [
    ...
    "Sudirman City View Apartments": {
        ...
        image: "assets/prop_apartment_1777425905682.png",
        ratingScore: 4.5,
        ratingCount: 112,
        facilities: [
        ...
        rooms: [
            { name: "Studio Apartment", description: "Cozy and efficient, perfect for solo travelers or business trips.", price: 90, type: "room" },
            { name: "1 Bedroom Apartment", description: "Separate living area and bedroom with great city views.", price: 130, type: "room" },
            { name: "Premium 3 Bedroom Penthouse", description: "Expansive luxury apartment for family or group stays.", price: 999, type: "room" }
        ],
        reviews: [
    ...
    "Le Bristol Paris": {
        ...
        rooms: [
            { name: "Superior Room", description: "Elegant Parisian decor overlooking the quiet courtyard.", price: 550, type: "room" },
            { name: "Deluxe Balcony Room", description: "Spacious room with a private balcony and city views.", price: 750, type: "room" },
            { name: "Prestige Suite", description: "Luxurious suite with a separate living room and marble bathroom.", price: 1200, type: "room" }
        ],
        reviews: [
    ...
    "Eiffel View Apartment": {
        ...
        rooms: [
            { name: "Classic 1 Bedroom", description: "Charming apartment perfect for a romantic getaway.", price: 220, type: "room" },
            { name: "Premium 2 Bedroom", description: "More spacious, ideal for families or two couples.", price: 350, type: "room" }
        ],
        reviews: [
    ...
    "Shinjuku Grand Hotel": {
        ...
        rooms: [
            { name: "Standard Double Room", description: "Compact but perfectly appointed with modern Japanese aesthetics.", price: 300, type: "room" },
            { name: "Premium Corner Room", description: "Expansive windows offering dual-aspect views of the neon skyline.", price: 450, type: "room" },
            { name: "Sky Suite", description: "Located on the top floors with exclusive lounge access.", price: 800, type: "room" }
        ],
        reviews: [
    ...
    "Traditional Ryokan": {
        ...
        rooms: [
            { name: "Standard Tatami Room", description: "Classic tatami room with shared open-air bath access.", price: 300, type: "room" },
            { name: "Deluxe Room with Private Bath", description: "Spacious tatami room featuring your own private wooden bath.", price: 500, type: "room" }
        ],
        reviews: [
